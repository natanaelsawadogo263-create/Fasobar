    ...
    <header className="sticky top-0 z-40 border-b border-white/10 bg-[#07110e]/95 backdrop-blur-md">
      <div className="mx-auto flex h-14 max-w-6xl items-center gap-3 px-4 sm:h-16 sm:px-6">
        ...
        <div className="ml-auto flex items-center gap-2">
          <Link
            href="/connexion"
            className="hidden min-h-11 items-center rounded-lg px-3 py-2 text-[13px] font-semibold text-emerald-100/90 transition hover:bg-white/5 hover:text-white sm:inline-flex"
          >
            Se connecter
          </Link>
          <Link
            href="/inscription/activite"
            className="inline-flex min-h-11 items-center rounded-xl bg-emerald-500 px-3.5 text-[13px] font-semibold text-white shadow-sm transition hover:bg-emerald-400"
          >
      ...
      {open ? (
        <div className="border-t border-white/10 bg-[#07110e] px-4 py-4 md:hidden">
          ...
          <Link
            href="/connexion"
            onClick={() => setOpen(false)}
            className="mt-3 flex min-h-11 items-center justify-center rounded-xl border border-white/15 px-3 text-[14px] font-semibold text-white"
          >
            Se connecter
          </Link>
        </div>
